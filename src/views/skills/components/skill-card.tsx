    ...
    >
      <CardHeader className="pb-4">
        <div className="flex min-w-0 items-center gap-3">
          <div className="flex size-10 shrink-0 items-center justify-center rounded-xl border bg-muted/20 text-sm font-semibold text-foreground">SK</div>
      ...
      <CardContent className="space-y-3 text-sm">
        <div className="rounded-lg border bg-muted/20 px-3 py-2">
          ...
          <div className="mt-1 truncate font-medium text-foreground">{skill.title}</div>
        </div>
        <div className="rounded-lg border bg-muted/20 px-3 py-2">
          <div className="text-xs uppercase tracking-wide text-muted-foreground">Source</div>
          <div className="mt-1 truncate text-foreground">{skill.source}</div>
        </div>
        <div className="rounded-lg border bg-muted/20 px-3 py-2">
