...
type ButtonProps = ButtonModeProps & {
  className?: string
...
function resolveVariantProps(variant: ButtonVariant | undefined): ButtonModeProps | null {
...
export const Button = forwardRef(function Button(
  { color, outline, plain, variant, unstyled = false, className, children, ...props }: ButtonProps,
  ref: React.ForwardedRef<HTMLElement>
) {
  const variantProps = resolveVariantProps(variant)
  const resolvedColor = variantProps && 'color' in variantProps ? variantProps.color : color
  const resolvedOutline = variantProps && 'outline' in variantProps ? variantProps.outline : outline
  const resolvedPlain = variantProps && 'plain' in variantProps ? variantProps.plain : plain
  ...
  if (unstyled) {
    ...
    return typeof props.href === 'string' ? (
      <Link {...props} className={unstyledClasses} ref={ref as React.ForwardedRef<HTMLAnchorElement>}>
