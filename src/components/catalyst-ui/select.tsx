...
export const Select = forwardRef(function Select(
  { className, multiple, size = 'md', invalid, ...props }: NativeSelectProps,
    ...
    >
      <Headless.Select
        ...
        className={clsx([
          ...
          multiple ? sizeStyles[size].multiple : sizeStyles[size].single,
          // Options (multi-select)
          '[&_optgroup]:font-semibold',
          // Typography
          'text-zinc-950 placeholder:text-zinc-500 dark:text-white dark:*:text-white',
          // Border
