...
function createChannelConfig(now: number, overrides: Partial<ChannelConfigRecord>): ChannelConfigRecord {
  return {
    ...
    wechatMiniProgramAppId: overrides.wechatMiniProgramAppId,
    wechatMiniProgramAppSecret: overrides.wechatMiniProgramAppSecret,
    wechatMiniProgramToken: overrides.wechatMiniProgramToken,
    wechatMiniProgramEncodingAesKey: overrides.wechatMiniProgramEncodingAesKey,
    ...
    wechatPersonalQrStatus: overrides.wechatPersonalQrStatus,
