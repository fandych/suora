...
export const DEFAULT_REGISTRY_SOURCES: SkillRegistrySource[] = [
  {
    id: 'skills-sh',
    name: 'skills.sh',
    type: 'skills.sh',
    ...
    enabled: true,
    builtin: true,
    description: 'The open agent skills ecosystem by Vercel',
    icon: 'lucide:globe',
  },
  {
    ...
    enabled: true,
    builtin: true,
    description: 'Official Vercel agent skills collection',
 ...
 */
const FEATURED_SKILLS: RegistrySkillEntry[] = [
  {
  ...
  },
  {
    ...
    name: 'agent-browser',
    description: 'Browser automation CLI for AI agents — navigate, fill forms, take screenshots',
    author: 'vercel-labs',
    version: '1.0.0',
  ...
  },
  {
    ...
    name: 'find-skills',
    description: 'Helps discover and install agent skills from the skills.sh ecosystem',
    author: 'vercel-labs',
    version: '1.0.0',
  ...
  },
  {
    ...
    name: 'ai-sdk',
    description: 'Build AI-powered features using the Vercel AI SDK',
    author: 'anthropics',
    version: '1.0.0',
    repository: 'anthropics/skills',
    sourceId: 'skills-sh',
  ...
  },
  {
    ...
    description: 'Best practices for building Remotion video applications',
    author: 'remotion-dev',
    version: '1.0.0',
...
export async function browseRegistrySkills(
  ...
  const featured = FEATURED_SKILLS.map((s) => ({
    ...s,
