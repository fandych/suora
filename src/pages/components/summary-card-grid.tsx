import { EmptyCard } from "@/pages/components/resource-state"
...
export function SummaryCardGrid<T>({ emptyDescription, emptyTitle, items, renderItem }: SummaryCardGridProps<T>) {
  ...
  return (
    <div className="grid w-full min-w-0 justify-start gap-4 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4">
