    ...
    return [
      {
        ...
        getAttrs: (element) => ({ content: (element as HTMLElement).getAttribute("data-math-block") ?? "" }),
      },
    ]
  },
    ...
    return [
      {
        ...
        getAttrs: (element) => ({ content: (element as HTMLElement).getAttribute("data-math-inline") ?? "" }),
      },
    ]
  },
  renderHTML({ HTMLAttributes }) {
    ...
    return [
      {
        ...
        getAttrs: (element) => ({ code: (element as HTMLElement).getAttribute("data-mermaid") ?? "" }),
      },
    ]
  },
  renderHTML({ HTMLAttributes }) {
