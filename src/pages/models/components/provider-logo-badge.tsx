...
import { getProviderBrandClassName, getProviderLogo } from "@/pages/components/provider-logo"
...
export function ProviderLogoBadge({ providerType, className, iconClassName }: ProviderLogoBadgeProps) {
  ...
  return (
    <span
      className={cn("flex size-9 items-center justify-center rounded-xl border border-border bg-background", className)}
    >
