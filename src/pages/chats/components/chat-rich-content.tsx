...
import { markdownToTiptapHtml } from "@/pages/components/document-markdown"
...
export function ChatRichContent({ content, isStreaming = false }: ChatRichContentProps) {
      ...
      copyButton.addEventListener("click", () => {
        void copyTextToClipboard(codeText)
          .then(() => {
            showToast({
              title: "Code copied",
              description: "The code block was copied to clipboard.",
              type: "success",
              timeout: 2000,
            })
          })
  ...
  return (
    <div
      ref={containerRef}
      className="document-prose chat-prose min-w-0 max-w-none text-sm"
