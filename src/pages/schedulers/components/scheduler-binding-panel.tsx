...
export function SchedulerBindingPanel({
  agents,
  draft,
  onChange,
  onTargetIdChange,
  ...
  useEffect(() => {
    ...
    void WorkflowApi.get(draft.targetId)
      .then((detail) => {
          ...
          <>
            ...
            <Field>
              ...
              <Textarea
                ...
                value={readAgentPrompt(draft.inputPayloadJson)}
                onChange={(event) =>
                  onChange({
                    ...draft,
                    inputPayloadJson: stringifyPayload({
                      ...readPayload(draft.inputPayloadJson),
