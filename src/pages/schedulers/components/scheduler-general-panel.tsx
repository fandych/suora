          ...
          <div className="grid gap-5 md:grid-cols-2">
            <Field>
              ...
              <Input
                ...
                onChange={(event) => onChange({ ...draft, retryLimit: Math.max(0, Number(event.target.value) || 0) })}
              />
            </Field>
            <Field>
              ...
              <Input
                ...
                type="number"
                min="0"
                value={String(draft.retryBackoffSeconds)}
                onChange={(event) =>
                  onChange({ ...draft, retryBackoffSeconds: Math.max(0, Number(event.target.value) || 0) })
                }
              />
            </Field>
          </div>
