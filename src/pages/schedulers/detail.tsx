...
import { SchedulerBindingPanel } from "@/pages/schedulers/components/scheduler-binding-panel"
import { SchedulerGeneralPanel } from "@/pages/schedulers/components/scheduler-general-panel"
import { SchedulerRunHistory } from "@/pages/schedulers/components/scheduler-run-history"
        ...
        actions={
          draft ? (
            <DropdownMenu>
              <DropdownMenuTrigger
                render={
                  <Button variant="ghost" size="icon-sm" aria-label="Scheduler actions" title="Scheduler actions" />
                }
              >
                <EllipsisIcon />
              </DropdownMenuTrigger>
              <DropdownMenuContent align="end" className="w-48 min-w-48">
                ...
                <DropdownMenuItem onClick={() => void handleToggleEnabled()}>
                  {draft.enabled ? <PauseIcon /> : <PlayIcon />}
