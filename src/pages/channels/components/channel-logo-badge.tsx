...
import { getChannelPlatformLogo } from "@/pages/channels/components/channel-utils"
...
export function ChannelLogoBadge({ channel, className, iconClassName }: ChannelLogoBadgeProps) {
  ...
  return (
    ...
    >
      <Logo
        className={cn("size-5 shrink-0", getChannelPlatformBrandClassName(channel.platform, channel), iconClassName)}
      />
    </span>
  )
}
