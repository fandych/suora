...
export function ChannelPlatformWeChatWorkForm({ channel, onPatch }: ChannelPlatformWeChatWorkFormProps) {
  return (
    <div className="space-y-3">
      <FormGroupSection
        title="Enterprise WeChat verification"
        description="Enterprise WeChat uses the callback token and AES key from the event subscription setup to validate inbound webhook traffic."
      >
        <div className="grid gap-3 md:grid-cols-2">
          ...
          <Field label="Encoding AES key" className="md:col-span-2">
            <CompactInput
              ...
              placeholder="43-character AES key"
            />
          </Field>
        </div>
      </FormGroupSection>
