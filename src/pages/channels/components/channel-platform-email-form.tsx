        ...
        <div className="grid gap-3 md:grid-cols-2">
          ...
          <Field label="Poll interval (seconds)">
            <CompactInput
              ...
              onChange={(event) => onPatch({ emailPollInterval: Math.max(10, Number(event.target.value) || 60) })}
            />
          </Field>
        </div>
          ...
          <Button
            ...
            onClick={() =>
              onPatch({
                emailFilters: [
                  ...emailFilters,
                  { id: crypto.randomUUID(), field: "subject", operator: "contains", value: "", enabled: true },
                ],
              })
            }
          >
          ...
          <Button
            ...
            onClick={() =>
              onPatch({
                emailActions: [
                  ...emailActions,
                  { id: crypto.randomUUID(), type: "auto_reply", value: "", enabled: true, useAgent: true },
                ],
              })
            }
          >
