  ...
  return (
    <div className="space-y-3">
      <FormGroupSection
        ...
        description="Add the bot registration identifiers from Azure so Teams can authenticate and route bot traffic correctly."
      >
        <div className="grid gap-3 md:grid-cols-2">
          ...
          <Field label="Tenant ID">
            <CompactInput
              ...
              placeholder="Use a tenant ID for single-tenant apps"
            />
          </Field>
          <Field label="Bot endpoint">
            <CompactInput
              ...
              placeholder="Auto-filled after binding"
            />
          </Field>
        </div>
      </FormGroupSection>
