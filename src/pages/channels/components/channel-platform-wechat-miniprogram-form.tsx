...
export function ChannelPlatformWeChatMiniProgramForm({ channel, onPatch }: ChannelPlatformWeChatMiniProgramFormProps) {
  return (
    <div className="space-y-3">
      <FormGroupSection
        title="Mini Program credentials"
        description="Mini Program callbacks and custom-service messaging use a dedicated App ID, app secret, verification token, and optional AES key. Keep it separate from Enterprise WeChat and Official Account credentials."
      >
