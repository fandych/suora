...
import {
  ...
  matchesEmailFilters,
  type ParsedEmail,
} from "@/electron/app/channels/runtime/channel-runtime-email"
import {
  hasGenericMessageContent,
  readGenericWebhookMessage,
  requireWebhookSecret,
} from "@/electron/app/channels/webhook/channel-webhook-common"
import { resolveTimestamp } from "@/electron/app/channels/webhook/channel-webhook-normalizers"
import {
  dispatchGetWebhook,
  respondUnsupportedMethod,
  respondUnsupportedPlatform,
  type EmitChannelMessage,
} from "@/electron/app/channels/webhook/channel-webhook-dispatch"
import {
  handleDingTalkWebhook,
  handleFeishuWebhook,
  handleWeChatWebhook,
} from "@/electron/app/channels/webhook/channel-webhook-platforms"
import {
  handleTelegramWebhook,
  handleTeamsWebhook,
} from "@/electron/app/channels/webhook/channel-webhook-messaging-platforms"
...
async function handleWeChatPersonalWebhook(
  req: Request,
  res: Response,
  channel: ChannelConfigRecord,
  emitMessage: EmitMessage,
