...
const DISALLOWED_EXECUTABLES = new Set(["bash", "cmd", "powershell", "pwsh", "sh", "zsh", "wscript", "cscript"])
...
function tokenizeCommand(command: string) {
  ...
  if (quote) throw new Error("Command has an unterminated quoted argument.")
