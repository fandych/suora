...
import { z } from "zod"
import { syncChannelCatalog } from "@/electron/app/channels/repositories/channel-catalog-repository"
...
export function registerDomainChannelCatalogIpc() {
  ipcMain.handle("database:syncChannelCatalog", (_event, value: unknown) =>
    syncChannelCatalog(syncSchema.parse(value)),
  )
}
