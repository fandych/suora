...
const canonicalDocumentationSections: CanonicalDocSection[] = [
    ...
    items: [
      {
        ...
        path: "/doc",
        description: { zh: "认识 SUORA 文档站", en: "Start with the SUORA documentation portal" },
      },
      {
  ...
  },
  {
    ...
    items: [
      {
        title: { zh: "聊天", en: "Chats" },
        path: "/doc/chat/overview",
        description: { zh: "创建会话、发送消息与导出转录", en: "Create chats, send messages, and export transcripts" },
        icon: MessageCircleIcon,
        iconClassName: "text-sky-500",
      },
      {
        title: { zh: "智能体", en: "Agents" },
        path: "/doc/agents/overview",
        description: {
          zh: "配置模型、资源范围与工具边界",
          en: "Configure models, resource scope, and tool boundaries",
        },
        icon: BotIcon,
      ...
      },
      {
        ...
        path: "/doc/workflows/overview",
        description: { zh: "设计、验证、发布并运行工作流", en: "Design, validate, publish, and run workflows" },
        icon: WorkflowIcon,
        iconClassName: "text-emerald-600",
      },
      {
        title: { zh: "调度器", en: "Schedulers" },
        path: "/doc/schedulers/overview",
        description: { zh: "维护工作流和智能体的调度配置", en: "Maintain workflow and agent scheduling configs" },
        icon: CalendarClockIcon,
        iconClassName: "text-amber-500",
      },
      {
        title: { zh: "集成", en: "Integrations" },
        path: "/doc/integrations/overview",
        description: { zh: "连接 HTTP、脚本和 MCP 端点", en: "Connect HTTP, script, and MCP endpoints" },
        icon: PlugZapIcon,
        iconClassName: "text-orange-500",
      },
      {
        title: { zh: "文档", en: "Documents" },
        path: "/doc/documents/overview",
        description: { zh: "组织页面、资源与本地知识", en: "Organize pages, assets, and local knowledge" },
        icon: BookOpenTextIcon,
        iconClassName: "text-blue-500",
      },
      {
        title: { zh: "渠道", en: "Channels" },
        path: "/doc/channels/overview",
        description: { zh: "接入外部消息平台与自动回复", en: "Connect external messaging platforms and auto replies" },
        icon: RadioTowerIcon,
        iconClassName: "text-teal-500",
      },
      {
        title: { zh: "技能", en: "Skills" },
        path: "/doc/skills/overview",
        description: { zh: "创建、组织并复用本地技能包", en: "Create, organize, and reuse local skill bundles" },
        icon: SparklesIcon,
        iconClassName: "text-fuchsia-500",
      },
      {
        title: { zh: "模型", en: "Models" },
        path: "/doc/models/overview",
        description: {
          zh: "配置提供商、模型和远程模型目录",
          en: "Configure providers, models, and remote model catalogs",
        },
        icon: BrainCircuitIcon,
        iconClassName: "text-rose-500",
      },
      {
        title: { zh: "偏好设置", en: "Preferences" },
        path: "/doc/preferences/overview",
        description: {
          zh: "设置外观、工具策略、SMTP 和更新行为",
          en: "Configure appearance, tool policy, SMTP, and updates",
        },
        icon: SettingsIcon,
        iconClassName: "text-amber-500",
      },
  ...
  },
  {
    ...
    items: [
      {
        title: { zh: "应用架构", en: "Architecture" },
        path: "/doc/technical/architecture",
        description: { zh: "Renderer、IPC 与本地服务", en: "Renderer, IPC, and local services" },
      },
      {
        title: { zh: "IPC 通信", en: "IPC" },
        path: "/doc/technical/ipc",
        description: { zh: "Preload、IPC handlers 与安全边界", en: "Preload, IPC handlers, and safety boundaries" },
      },
      {
        title: { zh: "SQLite 数据层", en: "SQLite Data Layer" },
        path: "/doc/technical/database",
        description: { zh: "Migration、Schema 与本地持久化", en: "Migrations, schema, and local persistence" },
      },
      {
        title: { zh: "AI 服务与工具", en: "AI Services & Tools" },
        path: "/doc/technical/ai",
        description: { zh: "Provider、ToolLoopAgent 与工具护栏", en: "Providers, ToolLoopAgent, and tool guardrails" },
      },
      {
        title: { zh: "工作流引擎", en: "Workflow Engine" },
        path: "/doc/technical/workflow-engine",
        description: {
          zh: "图调度、节点执行与运行时语义",
          en: "Graph scheduling, node execution, and runtime semantics",
        },
      },
      {
        title: { zh: "渠道运行时", en: "Channel Runtime" },
        path: "/doc/technical/channel-runtime",
        description: {
          zh: "Webhook、Stream、消息队列与健康检查",
          en: "Webhooks, streams, message queues, and health checks",
        },
      },
      {
        title: { zh: "测试与发布", en: "Testing & Release" },
        path: "/doc/technical/testing-release",
        description: { zh: "测试、CI、打包与发布流程", en: "Testing, CI, packaging, and release flows" },
      },
      {
        title: { zh: "生产发布检查清单", en: "Production Release Checklist" },
        path: "/doc/technical/production-checklist",
        description: { zh: "上线前的人工作业与风险核对项", en: "Pre-release operational and risk checks" },
      },
      {
        title: { zh: "安全护栏", en: "Security Guardrails" },
        path: "/doc/technical/security",
        description: { zh: "URL、工具、脚本、MCP 与 IPC 安全边界", en: "URL, tools, scripts, MCP, and IPC boundaries" },
      },
      {
        title: { zh: "浏览器工具", en: "Browser Tools" },
        path: "/doc/technical/browser",
        description: { zh: "浏览器会话、页面读取与表单操作", en: "Browser sessions, page reads, and form actions" },
      },
      {
        title: { zh: "开发与发布", en: "Development & Delivery" },
        path: "/doc/technical/development",
        description: { zh: "质量检查、构建与发布", en: "Quality checks, builds, and delivery" },
      },
    ],
  },
]
