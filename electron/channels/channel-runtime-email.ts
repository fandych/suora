import type { ChannelConfigRecord, EmailAction, EmailFilterRule } from "@shared/domain/channel-models"
import { httpRequest } from "@electron/channels/channel-runtime-http"
import { getSystemMailProfile, sendMail, type MailAttachment, type MailProfile } from "@electron/services/mail-service"
