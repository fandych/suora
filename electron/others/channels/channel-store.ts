import type { ChannelConfigRecord, ChannelDetail, ChannelRuntimeState } from "@/data/domain/channel-models"
import { applyMigrations, openDatabase } from "@electron/others/infrastructure/db-core"
import { preserveConfiguredChannelCredentials, protectChannelCredentials, revealChannelCredentials } from "@electron/others/channels/channel-credential-serialization"
